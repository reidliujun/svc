...
EditDistance::EditDistance():d(2500)
{
}

#ifdef OPTIMIZE_ED
int EditDistance::CalEditDistance(const char_t *s,const char_t *t, int limit)
...
#else
int EditDistance::CalEditDistance(const char_t *s,const char_t *t,const int limit)
{
    //Step 1
    int k,i,j,n,m,cost;
    n=strlen(s);
