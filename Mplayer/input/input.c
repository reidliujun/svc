...
static const mp_cmd_t mp_cmds[] = {
  ...
  { MP_CMD_SVC_LAYER_UP, "layer_up", 0, { {-1,{0}} } },
  { MP_CMD_SVC_LAYER_DOWN, "layer_down", 0, { {-1,{0}} } },  
  { MP_CMD_SVC_TEMP_UP, "temporal_id_up", 0, { {-1,{0}} } },
  { MP_CMD_SVC_TEMP_DOWN, "temporal_id_down", 0, { {-1,{0}} } }, 
