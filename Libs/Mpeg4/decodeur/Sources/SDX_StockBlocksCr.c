...
void SDX_StockBlocksCr ( const int MBpos, const short *RESTRICT BuffX, const struct_VOLsimple *RESTRICT VOLsimple
    ...
    , short *RESTRICT BuffB, short *RESTRICT BuffC, short *RESTRICT stockage_ligne )
{
  ...
  // ERRverror("",ERR_NO_HEADER | ERR_INFO,"I'm in function: StockBlocksColor_c generated from method: StockBlocksColor.stockblkColor\n");
  //return(1);
}
